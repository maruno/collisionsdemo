...
#include <string.h>
#include <stdlib.h>
#include "objectloader/obj_parser.h"
#include "objectloader/list.h"
#include "objectloader/string_extra.h"
...
int parse_obj_scene(obj_scene_data *data_out, char* file)
{
	obj_growable_scene_data growable_data;

	obj_init_temp_storage(&growable_data);
	if( obj_parse_obj_file(&growable_data, file) == 0)
		return 0;
