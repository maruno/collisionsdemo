...
ColouredPhongSceneItem::ColouredPhongSceneItem(glm::vec3 initialLocation, std::string objectName, ColourInformationUniform colour)
: scene::SceneItem(initialLocation, objectName) {
